...
import ccm.gospel.misook.local.bookmark.BookmarkFragment;
import ccm.gospel.misook.local.feed.FeedFragment;
import ccm.gospel.misook.local.subscription.SubscriptionFragment;
import ccm.gospel.misook.report.ErrorActivity;
import ccm.gospel.misook.report.UserAction;
import ccm.gospel.misook.util.KioskTranslator;
...
import ccm.gospel.misook.util.Utils;
...
public class MainFragment extends BaseFragment implements TabLayout.OnTabSelectedListener, CustomPopupListener {
    ...
    protected void initViews(View rootView, Bundle savedInstanceState) {
        ...
        CustomPopup.startCustomPopup(getActivity(), "kzn1q5gy");
