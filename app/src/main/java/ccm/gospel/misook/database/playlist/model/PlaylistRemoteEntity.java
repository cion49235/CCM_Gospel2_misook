package ccm.gospel.misook.database.playlist.model;
...
import ccm.gospel.misook.database.playlist.PlaylistLocalItem;
import ccm.gospel.misook.util.Constants;

import static ccm.gospel.misook.database.playlist.model.PlaylistRemoteEntity.REMOTE_PLAYLIST_NAME;
import static ccm.gospel.misook.database.playlist.model.PlaylistRemoteEntity.REMOTE_PLAYLIST_SERVICE_ID;
import static ccm.gospel.misook.database.playlist.model.PlaylistRemoteEntity.REMOTE_PLAYLIST_TABLE;
import static ccm.gospel.misook.database.playlist.model.PlaylistRemoteEntity.REMOTE_PLAYLIST_URL;
