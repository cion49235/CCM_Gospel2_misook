...
import ccm.gospel.misook.database.playlist.PlaylistStreamEntry;
...
import static ccm.gospel.misook.database.playlist.model.PlaylistEntity.PLAYLIST_NAME;
import static ccm.gospel.misook.database.playlist.model.PlaylistEntity.PLAYLIST_TABLE;
import static ccm.gospel.misook.database.playlist.model.PlaylistEntity.PLAYLIST_THUMBNAIL_URL;
import static ccm.gospel.misook.database.playlist.model.PlaylistStreamEntity.JOIN_INDEX;
import static ccm.gospel.misook.database.playlist.model.PlaylistStreamEntity.JOIN_PLAYLIST_ID;
import static ccm.gospel.misook.database.playlist.model.PlaylistStreamEntity.JOIN_STREAM_ID;
import static ccm.gospel.misook.database.playlist.model.PlaylistStreamEntity.PLAYLIST_STREAM_JOIN_TABLE;
