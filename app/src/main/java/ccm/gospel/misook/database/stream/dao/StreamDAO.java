package ccm.gospel.misook.database.stream.dao;
...
import static ccm.gospel.misook.database.history.model.StreamHistoryEntity.STREAM_HISTORY_TABLE;
import static ccm.gospel.misook.database.playlist.model.PlaylistStreamEntity.PLAYLIST_STREAM_JOIN_TABLE;
import static ccm.gospel.misook.database.stream.model.StreamEntity.STREAM_ID;
import static ccm.gospel.misook.database.stream.model.StreamEntity.STREAM_SERVICE_ID;
import static ccm.gospel.misook.database.stream.model.StreamEntity.STREAM_TABLE;
import static ccm.gospel.misook.database.stream.model.StreamEntity.STREAM_URL;
