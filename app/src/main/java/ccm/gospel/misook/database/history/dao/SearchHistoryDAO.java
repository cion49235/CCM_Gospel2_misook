...
import static ccm.gospel.misook.database.history.model.SearchHistoryEntry.CREATION_DATE;
import static ccm.gospel.misook.database.history.model.SearchHistoryEntry.ID;
import static ccm.gospel.misook.database.history.model.SearchHistoryEntry.SEARCH;
import static ccm.gospel.misook.database.history.model.SearchHistoryEntry.SERVICE_ID;
import static ccm.gospel.misook.database.history.model.SearchHistoryEntry.TABLE_NAME;
