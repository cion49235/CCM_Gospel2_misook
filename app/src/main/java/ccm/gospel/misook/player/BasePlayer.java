...
import ccm.gospel.misook.Downloader;
import ccm.gospel.misook.R;
import ccm.gospel.misook.local.history.HistoryRecordManager;
import ccm.gospel.misook.player.helper.AudioReactor;
import ccm.gospel.misook.player.helper.LoadController;
import ccm.gospel.misook.player.helper.MediaSessionManager;
import ccm.gospel.misook.player.helper.PlayerDataSource;
import ccm.gospel.misook.player.helper.PlayerHelper;
import ccm.gospel.misook.player.mediasource.FailedMediaSource;
import ccm.gospel.misook.player.playback.BasePlayerMediaSession;
import ccm.gospel.misook.player.playback.CustomTrackSelector;
import ccm.gospel.misook.player.playback.MediaSourceManager;
import ccm.gospel.misook.player.playback.PlaybackListener;
import ccm.gospel.misook.player.playqueue.PlayQueue;
import ccm.gospel.misook.player.playqueue.PlayQueueAdapter;
import ccm.gospel.misook.player.playqueue.PlayQueueItem;
import ccm.gospel.misook.util.SerializedCache;

import static com.google.android.exoplayer2.Player.DISCONTINUITY_REASON_INTERNAL;
import static com.google.android.exoplayer2.Player.DISCONTINUITY_REASON_PERIOD_TRANSITION;
import static com.google.android.exoplayer2.Player.DISCONTINUITY_REASON_SEEK;
import static com.google.android.exoplayer2.Player.DISCONTINUITY_REASON_SEEK_ADJUSTMENT;
import static ccm.gospel.misook.player.helper.PlayerHelper.getTimeString;
